...
const TOOLS: CreateTool[] = [
  ...
  { id: "factory-build-record", title: "Factory Build Record", description: "Generated automatically at ingest — review and publish here.", category: "Labels & Stickers", iconKey: "new-car-sticker", iconCategory: "sticker", route: "/admin?tab=labels", tags: ["factory", "build", "record", "monroney", "window sticker", "msrp", "oem", "review", "publish"], chip: "Sticker" },
