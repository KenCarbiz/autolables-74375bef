        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex justify-end" onClick={() => setSelected(null)}>
          <div onClick={(e) => e.stopPropagation()} className="w-full max-w-lg h-full overflow-y-auto bg-background border-l border-border p-5 space-y-4">
            <div className="flex items-start justify-between gap-3">
              <div>
                <div className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">
            ...
            {selected.recommended_action && (
              <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-3 text-sm text-amber-800">
                <div className="text-al-meta font-bold uppercase tracking-wider mb-0.5">Recommended action</div>
                {selected.recommended_action}
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="rounded-lg border border-border p-2.5">
                <div className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">Created</div>
                <div className="text-foreground">{new Date(selected.created_at).toLocaleString()}</div>
              </div>
              <div className="rounded-lg border border-border p-2.5">
                <div className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">Due</div>
            ...
            <div className="space-y-3 rounded-xl border border-border p-3">
              <div className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">Actions</div>
              <div>
                <label className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">Status</label>
              ...
              <div>
                <label className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground">Assign to</label>
              ...
              <ul className="space-y-2">
                {comments.map((c) => (
                  <li key={c.id} className="rounded-md border border-border p-2 text-xs">
                    <div className="flex items-center gap-2 text-al-meta font-bold uppercase tracking-wider text-muted-foreground">
