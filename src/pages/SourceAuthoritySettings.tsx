            ...
            <section key={group.group} className="rounded-2xl border border-border bg-card overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="text-al-meta font-bold uppercase tracking-wider text-muted-foreground bg-muted/20">
                    <tr>
...
const DefaultChip = () => (
  <span className="inline-flex items-center h-5 px-2 rounded-full bg-muted text-al-meta font-bold uppercase tracking-wider text-muted-foreground border border-border">
    Default
  </span>
);
const DirtyChip = () => (
  <span className="inline-flex items-center h-5 px-2 rounded-full bg-amber-500/15 text-al-meta font-bold uppercase tracking-wider text-amber-800 border border-amber-500/30">
    Unsaved
  </span>
);
