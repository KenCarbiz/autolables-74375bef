...
const LABELS: Record<Language, Record<string, string>> = {
  en: {
    ...
    as_is_body: "THE DEALER DOES NOT PROVIDE A WARRANTY FOR ANY REPAIRS AFTER SALE. YOU WILL PAY ALL COSTS FOR ANY REPAIRS. The dealer assumes no responsibility for any repairs regardless of any oral statements about the vehicle.",
  ...
  es: {
    ...
    as_is_body: "EL CONCESIONARIO NO OFRECE GARANTÍA PARA NINGUNA REPARACIÓN DESPUÉS DE LA VENTA. USTED PAGARÁ TODOS LOS COSTOS DE CUALQUIER REPARACIÓN. El concesionario no asume ninguna responsabilidad por cualquier reparación sin importar cualquier declaración verbal sobre el vehículo.",
