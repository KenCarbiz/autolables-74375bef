...
export const STUDIO_TEMPLATES: StudioTemplate[] = [
  ...
  { config: baseWindow({ id: "window-minimal", name: "Minimal High-Readability", styleTags: ["Minimal", "Readability"], defaultAccent: "#0B2041", supportsAccent: false, useCase: "Maximum legibility, low ink" }), Render: WindowSheet },
