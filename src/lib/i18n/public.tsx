...
export const LABELS: Record<PublicLocale, PublicMessages> = {
  en: {
    ...
    reserve_vehicle: "Check availability",
    reserved: "Request sent",
    reserved_subtitle: "{n} will be in touch shortly.",
    vehicle_held_title: "Request received.",
    vehicle_held_body:
      "The dealer has your request and will confirm availability shortly during business hours. No contract, no cost.",
    dealership: "Dealership",
    close: "Close",
    reserve_intro:
      "Tell us what you'd like to do next. The dealer will reach out with next steps — no contract, no cost.",
    hold_for_me: "Check availability",
    ...
    archived: "Documented",
    archived_title:
      "Every signed document for this vehicle is kept on file for 7 years.",
