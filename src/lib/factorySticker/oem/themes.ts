...
export const THEME_REGISTRY: Record<OemId, OemStickerTheme> = {
  INFINITI: theme("INFINITI", "PREMIUM_LUXURY", {
    ...
    accent: "#0b1f3a",
    divider: "#d8dadd",
    sectionHeadingText: "#0b1f3a",
    totalMsrpBackground: "#0b1f3a",
    totalMsrpText: "#ffffff",
  }),
  NISSAN: theme("NISSAN", "JAPANESE_MAINSTREAM", palette({ header: "#101010", accent: "#c3002f" })),
  TOYOTA: theme("TOYOTA", "JAPANESE_MAINSTREAM", palette({ header: "#1a1a1a", accent: "#eb0a1e" })),
  ...
  CHEVROLET: theme("CHEVROLET", "AMERICAN_MAINSTREAM", palette({ header: "#12284b", accent: "#cfa348" })),
  ...
  JEEP: theme("JEEP", "AMERICAN_MAINSTREAM", palette({ header: "#3e4d2c", accent: "#6b7d4f" })),
