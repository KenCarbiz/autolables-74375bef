...
export const cadillacEscaladeFixture = (): FactoryStickerRenderData => ({
  ...
  condition: "new",
  title: "Factory Window Sticker — Configuration & MSRP",
  vin: "1GYS4DKL8TR301234",
  identity: { year: "2026", make: "Cadillac", model: "Escalade", trim: "PREMIUM LUXURY 4WD" },
  pricing: { baseMsrp: 98295, destinationCharge: 2195, optionsTotal: 4690, totalMsrp: 105180 },
  options: [
    { name: "Super Cruise w/ 3-Year Service Period", code: "UF2", msrp: 2500 },
    { name: "22-Inch Dynamic Metal Wheels", code: "SQ8", msrp: 1565 },
    { name: "Premium Paint - Black Cherry Tintcoat", code: "GSK", msrp: 625 },
  ],
  standardEquipment: {
    mechanical: [
      "6.2L V8 Engine w/ Dynamic Fuel Management - 420 HP",
      "10-Speed Automatic Transmission",
      "Four-Wheel Drive w/ Electronic Limited-Slip Differential",
      "Magnetic Ride Control w/ Air Ride Adaptive Suspension",
      "Automatic Stop/Start",
    ],
    safety_features: [
      "Automatic Emergency Braking w/ Front Pedestrian Braking",
      "Enhanced Automatic Parking Assist",
      "HD Surround Vision w/ Augmented Reality Navigation",
      "Lane Keep Assist w/ Lane Departure Warning",
      "Rear Cross Traffic Braking",
      "Night Vision",
    ],
    interior: [
      "55-Inch Total Diagonal Curved OLED Display",
      "Semi-Aniline Leather Seating",
      "Heated & Ventilated Front Seats w/ Massage",
      "Heated Second-Row Captain's Chairs",
      "AKG Studio Audio - 19 Speakers",
      "Tri-Zone Automatic Climate Control",
      "Heated Power Steering Wheel",
      "Wireless Apple CarPlay & Android Auto",
      "Wireless Charging Pad",
    ...
    exterior: [
      "LED Headlamps w/ Cadillac Choreography Lighting",
      "Power Panoramic Sunroof",
      "Hands-Free Power Liftgate",
  ...
  colors: { exterior: { name: "Black Cherry Tintcoat", code: "GSK" }, interior: { name: "Whisper Beige", code: "WBG" } },
  assembly: { plant: "Arlington", city: "Arlington, Texas", country: "USA" },
  mechanical: { engine: "6.2L V8", transmission: "10-SPEED A/T", drivetrain: "4WD" },
  stockNumber: "C2660145",
  transportMethod: "RAIL",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: null, order: "CDK511", dealer: "204411" },
  epa: {
    city: 14, highway: 19, combined: 16, annualFuelCost: 3700, ghgScore: 2,
    rangeMiles: null, fuelType: "Premium Gasoline", smogScore: 5, gallonsPer100Miles: 6.3,
    fiveYearCostDifference: -6500, classNote: null,
  },
  safety: null,
  warranty: {
  ...
  dealer: { name: "Cadillac of Coral Gables", address: "4181 SW 8th St", city: "Coral Gables", state: "FL", zip: "33134", phone: null },
  passportUrl: "https://autolabels.io/v/demo-escalade",
  barcodePayload: "1GYS4DKL8TR301234",
  disclaimers: [
    "Vehicle information compiled from verified manufacturer, regulatory and dealer data. This document may not be the original manufacturer-issued label.",
    "Digitally prepared by AutoLabels.io",
  ],
...
export const ramFixture = (): FactoryStickerRenderData => ({
  ...
  condition: "new",
  title: "Factory Window Sticker — Configuration & MSRP",
  vin: "1C6SRFJT8TN512345",
  identity: { year: "2026", make: "Ram", model: "Ram 1500", trim: "LARAMIE CREW CAB 4X4" },
  pricing: { baseMsrp: 62035, destinationCharge: 2095, optionsTotal: 5890, totalMsrp: 70020 },
  options: [
    { name: "Level 1 Equipment Group", code: "AGT", msrp: 3895, contents: ["Head-Up Display", "Digital Rearview Mirror"] },
    { name: "Panoramic Sunroof", code: "GWM", msrp: 1495 },
    { name: "Bed Utility Group", code: "XB9", msrp: 500 },
  ],
  standardEquipment: {
    mechanical: [
      "3.0L Hurricane Twin-Turbo I6 - 420 HP",
      "8-Speed TorqueFlite Automatic Transmission",
      "4x4 w/ Electronic Transfer Case",
    ...
    safety_features: [
      ...
      "Blind Spot Monitoring w/ Trailer Coverage",
    ...
    exterior: [
      ...
      "Full LED Premium Lighting",
      "Power-Folding Heated Tow Mirrors",
      "RamBox Cargo Management System",
      "Power Tailgate Release",
      "Spray-In Bedliner",
    ],
  },
  colors: { exterior: { name: "Delmonico Red Pearl", code: "PRV" }, interior: { name: "Sepia/Black", code: "SPB" } },
  assembly: { plant: "Sterling Heights", city: "Sterling Heights, Michigan", country: "USA" },
  mechanical: { engine: "3.0L TT I6", transmission: "8-SPEED A/T", drivetrain: "4X4" },
  stockNumber: "R2660145",
  transportMethod: "RAIL",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: null, order: "RMK220", dealer: "68412" },
  epa: {
    city: 18, highway: 24, combined: 20, annualFuelCost: 2900, ghgScore: 3,
    rangeMiles: null, fuelType: "Gasoline", smogScore: 5, gallonsPer100Miles: 5.0,
    fiveYearCostDifference: -3750, classNote: null,
  },
  safety: null,
  ...
  partsContent: [
    ...
    { label: "Major foreign parts content", value: "Mexico 20%" },
    { label: "Final assembly point", value: "Sterling Heights, Michigan, USA" },
    { label: "Country of origin - engine", value: "Mexico" },
    { label: "Country of origin - transmission", value: "USA" },
  ],
  dealer: { name: "Ram Trucks of Hialeah", address: "1650 W 49th St", city: "Hialeah", state: "FL", zip: "33012", phone: null },
  passportUrl: "https://autolabels.io/v/demo-ram1500",
  barcodePayload: "1C6SRFJT8TN512345",
  disclaimers: [
    "Vehicle information compiled from verified manufacturer, regulatory and dealer data. This document may not be the original manufacturer-issued label.",
    "Digitally prepared by AutoLabels.io",
  ],
...
// ── Volkswagen fixtures (german-technical, volkswagen-us-2026-v1) ──────

// Atlas SEL 4Motion. 49,675 + 995 + 1,425 = 52,095.
...
export const audiQ5Fixture = (): FactoryStickerRenderData => ({
  ...
  condition: "new",
  title: "Factory Window Sticker — Configuration & MSRP",
  vin: "WA1E2BFY8T2101234",
  identity: { year: "2026", make: "Audi", model: "Q5", trim: "PREMIUM PLUS 45 QUATTRO" },
  pricing: { baseMsrp: 53600, destinationCharge: 1395, optionsTotal: 1550, totalMsrp: 56545 },
  options: [
    { name: "S line Exterior Package", code: "WQS", msrp: 750 },
    { name: "Black Optic Package", code: "PBO", msrp: 800 },
  ],
  standardEquipment: {
    mechanical: [
      "2.0L TFSI Turbocharged I4 - 268 HP",
      "7-Speed S tronic Dual-Clutch Transmission",
      "quattro All-Wheel Drive w/ ultra Technology",
      "Audi Drive Select",
    ...
    interior: [
      ...
      "Bang & Olufsen Premium Sound - 16 Speakers",
      "Three-Zone Automatic Climate Control",
      "Heated Steering Wheel",
      "Wireless Apple CarPlay & Android Auto",
    ...
    exterior: [
      "20-Inch 5-Double-Spoke Wheels",
      "Matrix-Design LED Headlights",
      "Panoramic Sunroof",
      "Power Tailgate",
      "Power-Folding Heated Mirrors",
      "Adaptive Rear Spoiler Trim",
    ],
  },
  colors: { exterior: { name: "Daytona Gray Pearl", code: "6Y" }, interior: { name: "Okapi Brown", code: "OK" } },
  ...
  stockNumber: "A2660145",
  transportMethod: "RAIL",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: null, order: "AUD553", dealer: "421A55" },
  epa: {
    city: 23, highway: 28, combined: 25, annualFuelCost: 2150, ghgScore: 5,
    rangeMiles: null, fuelType: "Premium Gasoline", smogScore: 6, gallonsPer100Miles: 4.0,
    fiveYearCostDifference: -1000, classNote: null,
  },
  safety: null,
  warranty: {
  ...
  partsContent: [
    ...
    { label: "Major foreign parts content", value: "Mexico 42%" },
    { label: "Additional foreign parts content", value: "Germany 30%" },
    { label: "Final assembly point", value: "San Jose Chiapa, Mexico" },
    { label: "Country of origin - engine", value: "Hungary" },
    { label: "Country of origin - transmission", value: "Germany" },
  ],
  dealer: { name: "Audi Coral Gables", address: "4181 SW 8th St", city: "Coral Gables", state: "FL", zip: "33134", phone: null },
  passportUrl: "https://autolabels.io/v/demo-q5",
  barcodePayload: "WA1E2BFY8T2101234",
  disclaimers: [
    "Vehicle information compiled from verified manufacturer, regulatory and dealer data. This document may not be the original manufacturer-issued label.",
    "Digitally prepared by AutoLabels.io",
  ],
