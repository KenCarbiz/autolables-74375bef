...
// Owner's reference benchmark (2026-07-27 Land Rover directive). It
// reconciles exactly as printed: 92,175 + 5,500 + 1,475 = 99,150. The P400
// MHEV is a 48V mild hybrid — gasoline EPA layout, never a plug-in.
export const landRoverSportFixture = (): FactoryStickerRenderData => ({
  ...oemBase(),
  condition: "new",
  title: "Factory Window Sticker — Configuration & MSRP",
  vin: "SAL1L9FUXSA123456",
  identity: { year: "2026", make: "Land Rover", model: "Range Rover Sport", trim: "P400 DYNAMIC SE" },
  pricing: { baseMsrp: 92175, destinationCharge: 1475, optionsTotal: 5500, totalMsrp: 99150 },
  options: [
    { name: "Santorini Black Metallic", code: null, msrp: 950 },
    { name: '22-Inch Style 5127 Gloss Black Wheels', code: null, msrp: 1450 },
    {
      name: "Cold Climate Pack", code: null, msrp: 1150,
      contents: ["Heated Windshield", "Heated Washer Jets", "Heated Steering Wheel"],
    },
    { name: "Tow Hitch Receiver", code: null, msrp: 750 },
    { name: "Black Exterior Pack", code: null, msrp: 1200 },
  ],
  standardEquipment: {
    mechanical: [
      "3.0L Turbocharged & Supercharged I6 MHEV",
      "8-Speed Automatic Transmission",
      "All Wheel Drive (AWD)",
      "Terrain Response 2",
    ...
    exterior: [
      "LED Digital Headlights w/ Signature DRL",
    ...
    interior: [
      ...
      "14-Way Heated & Cooled Front Seats",
      "Heated Rear Seats",
      ...
      "Premium Carpet Mats",
      "Pivi Pro w/ 13.1-Inch Touchscreen",
      "Wireless Apple CarPlay",
      "Wireless Android Auto",
      "Meridian Sound System (825W)",
      "Wi-Fi Hotspot (Data Plan Required)",
      "USB-C Charging Ports",
    ],
  },
  colors: { exterior: { name: "Santorini Black Metallic", code: null }, interior: { name: "Ebony Windsor Leather", code: null } },
  assembly: { plant: "Solihull", city: "Solihull", country: "United Kingdom" },
  mechanical: { engine: "3.0L TURBO & SUPERCHARGED I6 MHEV", transmission: "8-SPEED AUTOMATIC", drivetrain: "ALL WHEEL DRIVE" },
  stockNumber: "LR260184",
  transportMethod: "TRUCK",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: null, order: null, dealer: null },
  epa: {
    city: 18, highway: 25, combined: 20, annualFuelCost: 3200, ghgScore: 4,
    rangeMiles: null, fuelType: "Premium Gasoline", smogScore: 5, gallonsPer100Miles: 5.0,
    fiveYearCostDifference: -5000, classNote: "Standard SUVs range from 14 to 118 MPG.",
  },
  safety: null,
  nhtsaNotRated: true,
  warranty: {
    basic: "4-Year/50,000-Mile New Vehicle Limited Warranty",
    powertrain: null,
    corrosion: "8-Year/100,000-Mile Corrosion Perforation Warranty",
    roadside: "Roadside Assistance for 4 Years/50,000 Miles",
    emissions: null,
  },
  partsContent: [
    { label: "U.S./Canadian parts content (carline)", value: "5%" },
    { label: "Major sources of foreign parts content", value: "United Kingdom 60%" },
    { label: "Additional foreign parts content", value: "Germany 20%" },
    { label: "Final assembly point", value: "Solihull, United Kingdom" },
    { label: "Country of origin - engine / transmission", value: "United Kingdom / Germany" },
  ],
  dealer: { name: "Harte Land Rover", address: "67 Weston Street", city: "Hartford", state: "CT", zip: "06120", phone: null },
  passportUrl: "https://autolabels.io/v/demo-rrsport",
  barcodePayload: "SAL1L9FUXSA123456",
  disclaimers: [
    "AutoLabels manufacturer-style reproduction generated from verified vehicle data. Not an original Land Rover-issued Monroney label.",
    "Digitally prepared by AutoLabels.io",
  ],
});

// Range Rover P550e SV LWB: plug-in hybrid on the long wheelbase, with SV
// Bespoke equipment. Never merged with the standard-wheelbase Range Rover
// or with Range Rover Sport. 187,400 + 12,850 + 1,475 = 201,725.
export const landRoverPhevFixture = (): FactoryStickerRenderData => ({
  ...landRoverSportFixture(),
  vin: "SALKPBE79TA509876",
  identity: { year: "2026", make: "Land Rover", model: "Range Rover", trim: "P550E SV LWB" },
  pricing: { baseMsrp: 187400, destinationCharge: 1475, optionsTotal: 12850, totalMsrp: 201725 },
  options: [
    { name: "SV Bespoke Premium Palette Paint", code: null, msrp: 6900 },
    { name: "SV Signature Suite Rear Seating", code: null, msrp: 4200 },
    { name: "23-Inch Style 1075 Diamond Turned Wheels", code: null, msrp: 1750 },
    { name: "Ceramic Rotary Controls", code: null, msrp: null, included: true },
  ],
  standardEquipment: {
    mechanical: [
      "3.0L Turbocharged I6 Plug-In Hybrid",
      "38.2 kWh Lithium-Ion Battery",
      "8-Speed Automatic Transmission",
      "All Wheel Drive w/ Intelligent Driveline Dynamics",
      "50 kW DC Fast Charging Capability",
      "7.2 kW AC Onboard Charger",
      "Electronic Air Suspension w/ Dynamic Response Pro",
      "All Wheel Steering",
    ],
    safety_features: [
      "Advanced Emergency Braking",
    ...
    exterior: [
      "SV Bespoke Exterior Detailing",
      "Digital LED Headlights w/ Signature DRL",
      "Flush Deployable Door Handles",
      "Powered Gesture Tailgate",
      "Charge Port - Left Front Fender",
    ],
    interior: [
      "SV Signature Suite Rear Seating w/ Club Table",
      "Semi-Aniline Leather Seats",
      "Executive Class Comfort Plus Rear Seats",
      "Hot Stone Massage Front & Rear Seats",
      "Four-Zone Climate Control w/ Cabin Air Purification Pro",
      "Meridian Signature Sound System",
      "Rear Seat Entertainment",
      "Refrigerated Front Center Console Compartment",
    ],
  },
  colors: { exterior: { name: "SV Bespoke Premium Palette", code: null }, interior: { name: "Perlino/Ebony Semi-Aniline", code: null } },
  mechanical: { engine: "3.0L I6 PLUG-IN HYBRID", transmission: "8-SPEED AUTOMATIC", drivetrain: "ALL WHEEL DRIVE" },
  stockNumber: "LR260509",
  epa: {
    city: null, highway: null, combined: 51, annualFuelCost: 1900, ghgScore: 8,
    rangeMiles: 48, fuelType: "PHEV Gasoline-Electric", smogScore: 7, gallonsPer100Miles: null,
    fiveYearCostDifference: -1250, classNote: null, gasCombinedMpg: 19,
  },
  warranty: {
    basic: "4-Year/50,000-Mile New Vehicle Limited Warranty",
    powertrain: null,
  ...
  passportUrl: "https://autolabels.io/v/demo-rr-sv",
  barcodePayload: "SALKPBE79TA509876",
});

// Defender 130 P400 Outbound: a distinct body length from the 90 and 110,
// built in Nitra, Slovakia — a different plant from the Solihull-built
// Range Rover, so assembly is matched per vehicle rather than per brand.
// 83,700 + 3,250 + 1,475 = 88,425.
export const landRoverDefenderFixture = (): FactoryStickerRenderData => ({
  ...landRoverSportFixture(),
  vin: "SALEA7EU4T2148902",
  identity: { year: "2026", make: "Land Rover", model: "Defender 130", trim: "P400 OUTBOUND" },
  pricing: { baseMsrp: 83700, destinationCharge: 1475, optionsTotal: 3250, totalMsrp: 88425 },
  options: [
    { name: "Sedona Red Premium Metallic", code: null, msrp: 1300 },
    { name: "Cold Climate Pack", code: null, msrp: 1150, contents: ["Heated Windshield", "Heated Washer Jets"] },
    { name: "Advanced Tow Assist", code: null, msrp: 800 },
    { name: "Full-Size Spare Wheel", code: null, msrp: null, included: true },
  ],
  standardEquipment: {
    mechanical: [
    ...
    exterior: [
      "Extended Body Length - 130 Configuration",
      "Exterior Side-Mounted Gear Carrier",
      "Roof Rails",
      "LED Headlights w/ Signature DRL",
      "20-Inch Style 5098 Wheels",
    ],
    interior: [
      "Five-Plus-Two Seating - Eight Seats",
      "Resist Textile & Kvadrat Seat Facings",
      "Heated Front & Second-Row Seats",
      "Three-Zone Climate Control",
      "Pivi Pro w/ 11.4-Inch Touchscreen",
      "Rubber Floor Mats",
    ],
  },
  colors: { exterior: { name: "Sedona Red Premium Metallic", code: null }, interior: { name: "Ebony Resist/Kvadrat", code: null } },
  assembly: { plant: "Nitra", city: "Nitra", country: "Slovakia" },
  mechanical: { engine: "3.0L TURBO I6 MHEV", transmission: "8-SPEED AUTOMATIC", drivetrain: "ALL WHEEL DRIVE" },
  stockNumber: "LR260148",
  epa: {
    city: 17, highway: 21, combined: 19, annualFuelCost: 3400, ghgScore: 4,
    rangeMiles: null, fuelType: "Premium Gasoline", smogScore: 5, gallonsPer100Miles: 5.3,
    fiveYearCostDifference: -6000, classNote: "Standard SUVs range from 14 to 118 MPG.",
  },
  partsContent: [
    { label: "U.S./Canadian parts content (carline)", value: "3%" },
    { label: "Major sources of foreign parts content", value: "Slovakia 45%" },
    { label: "Additional foreign parts content", value: "United Kingdom 25%" },
    { label: "Final assembly point", value: "Nitra, Slovakia" },
    { label: "Country of origin - engine / transmission", value: "United Kingdom / Germany" },
  ],
  passportUrl: "https://autolabels.io/v/demo-defender130",
...
// Buick — reference benchmark (Envision Avenir AWD). GM RPO codes, an
// Avenir-tier Preferred Equipment content list, and a real NHTSA rating
// set so the verified-stars path stays exercised.
// 47,595 + 4,205 + 1,395 = 53,195.
export const buickEnvisionFixture = (): FactoryStickerRenderData => ({
  ...oemBase(),
  condition: "new",
  title: "Factory Window Sticker — Configuration & MSRP",
  vin: "LRBFZSE41SD012345",
  identity: { year: "2025", make: "Buick", model: "Envision", trim: "AVENIR AWD" },
  pricing: { baseMsrp: 47595, destinationCharge: 1395, optionsTotal: 4205, totalMsrp: 53195 },
  options: [
    { name: "Moonstone Gray Metallic", code: "G7Q", msrp: 495 },
    {
      name: "Avenir Technology Package", code: "APF", msrp: 1965,
      contents: [
        "HD Surround Vision",
        "Adaptive Cruise Control",
        "Head-Up Display",
    ...
    { name: "Panoramic Power Moonroof", code: "CF5", msrp: 1495 },
    { name: "All-Weather Floor Liners", code: "RIA", msrp: 250 },
  ],
  standardEquipment: {
    safety_features: [
      "Automatic Emergency Braking",
      ...
      "Buckle to Drive",
      "Teen Driver",
      "Tire Pressure Monitoring w/ Fill Alert",
    ],
    mechanical: [
      "2.0L Turbocharged 4-Cylinder Engine",
      "9-Speed Automatic Transmission",
      "All-Wheel Drive w/ Twin-Clutch Rear Axle",
    ...
    exterior: [
      ...
      "245/45R20 All-Season Blackwall Tires",
      "LED Headlamps w/ LED Signature Lighting",
      "Hands-Free Power Liftgate",
      "Heated Power-Folding Outside Mirrors",
      "Acoustic Laminated Front Side Glass",
      "Roof Rails - Bright",
      "Avenir Exterior Ornamentation",
    ],
    interior: [
      "11-Inch Diagonal Color Touchscreen Display",
      "Google Built-In w/ Google Assistant and Maps",
      "Wireless Apple CarPlay and Android Auto",
  ...
  colors: {
    exterior: { name: "Moonstone Gray Metallic", code: "G7Q" },
    interior: { name: "Ebony w/ Sky Cool Gray Accents", code: "H2X" },
  },
  assembly: { plant: "San Luis Potosi", city: "San Luis Potosi", country: "Mexico" },
  mechanical: { engine: "2.0L TURBOCHARGED 4-CYLINDER", transmission: "9-SPEED AUTOMATIC", drivetrain: "AWD" },
  stockNumber: "B25017",
  transportMethod: "TRUCK",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: "4ZB26", order: "BZPHQ1", dealer: "12345" },
  epa: {
    city: 22, highway: 29, combined: 25, annualFuelCost: 2100, ghgScore: 5,
    rangeMiles: null, fuelType: "Gasoline", smogScore: 6, gallonsPer100Miles: 4.0,
    fiveYearCostDifference: 1250, classNote: "Small SUVs range from 14 to 125 MPG.",
  },
  safety: { overall: 5, frontalDriver: 5, frontalPassenger: 5, sideFront: 5, sideRear: 5, rollover: 4 },
  warranty: {
    basic: "3-Year/36,000-Mile Bumper-to-Bumper Limited Warranty",
    powertrain: "5-Year/60,000-Mile Powertrain Limited Warranty",
    corrosion: "6-Year/70,000-Mile Corrosion Perforation Warranty",
    roadside: "5-Year/60,000-Mile Roadside Assistance and Courtesy Transportation",
    emissions: null,
  },
  partsContent: [
    { label: "U.S./Canadian parts content (carline)", value: "38%" },
    { label: "Major sources of foreign parts content", value: "Mexico 27%" },
    { label: "Final assembly point", value: "San Luis Potosi, Mexico" },
    { label: "Country of origin - engine / transmission", value: "United States / Japan" },
  ],
  dealer: { name: "Example Buick of Anytown", address: "1200 Avenir Drive", city: "Anytown", state: "MI", zip: "48009", phone: null },
  passportUrl: "https://autolabels.io/v/demo-envision",
  barcodePayload: "LRBFZSE41SD012345",
  disclaimers: [
    "AutoLabels manufacturer-style reproduction generated from verified vehicle data. Not an original Buick-issued Monroney label.",
    "Digitally prepared by AutoLabels.io",
  ],
});

// Envista Sport Touring FWD: a separate Buick model line from Envision —
// its own base price, powertrain, EPA record and assembly point. Never
// inherits Envision or Encore GX data.
// 25,195 + 1,290 + 1,395 = 27,880.
export const buickEnvistaFixture = (): FactoryStickerRenderData => ({
  ...buickEnvisionFixture(),
  vin: "KL77LHE20SC204118",
  identity: { year: "2025", make: "Buick", model: "Envista", trim: "SPORT TOURING FWD" },
  pricing: { baseMsrp: 25195, destinationCharge: 1395, optionsTotal: 1290, totalMsrp: 27880 },
  options: [
    { name: "Ebony Twilight Metallic", code: "GB8", msrp: 495 },
    {
      name: "Sport Touring Convenience Package", code: "PCV", msrp: 545,
      contents: ["Heated Front Seats", "Heated Steering Wheel", "Remote Vehicle Start"],
    },
    { name: "All-Weather Floor Liners", code: "RIA", msrp: 250 },
  ],
  standardEquipment: {
    ...
    exterior: [
      ...
      "225/50R19 All-Season Blackwall Tires",
      "LED Headlamps w/ LED Signature Lighting",
      "Sport Touring Body-Color Rear Spoiler",
      "Black Roof Rails",
    ],
    interior: [
      "11-Inch Diagonal Color Touchscreen Display",
  ...
  colors: {
    exterior: { name: "Ebony Twilight Metallic", code: "GB8" },
    interior: { name: "Ebony", code: "H0Y" },
  },
  assembly: { plant: "Bupyeong", city: "Bupyeong", country: "South Korea" },
  mechanical: { engine: "1.2L TURBOCHARGED 3-CYLINDER", transmission: "6-SPEED AUTOMATIC", drivetrain: "FWD" },
  stockNumber: "B25204",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: "4LB26", order: "BZTRM4", dealer: "12345" },
  epa: {
    city: 28, highway: 32, combined: 30, annualFuelCost: 1750, ghgScore: 6,
    rangeMiles: null, fuelType: "Gasoline", smogScore: 5, gallonsPer100Miles: 3.3,
    fiveYearCostDifference: 3000, classNote: "Small SUVs range from 14 to 125 MPG.",
  },
  safety: null,
  nhtsaNotRated: true,
  partsContent: [
    { label: "U.S./Canadian parts content (carline)", value: "1%" },
    { label: "Major sources of foreign parts content", value: "South Korea 80%" },
    { label: "Final assembly point", value: "Bupyeong, South Korea" },
    { label: "Country of origin - engine / transmission", value: "South Korea / South Korea" },
  ],
  passportUrl: "https://autolabels.io/v/demo-envista",
  barcodePayload: "KL77LHE20SC204118",
});

// Enclave Avenir AWD: the three-row line. Distinct base price, V6
// powertrain, EPA class note and U.S. assembly point.
// 59,195 + 3,190 + 1,595 = 63,980.
export const buickEnclaveFixture = (): FactoryStickerRenderData => ({
  ...buickEnvisionFixture(),
  vin: "5GAEVCKS4SJ118207",
  identity: { year: "2025", make: "Buick", model: "Enclave", trim: "AVENIR AWD" },
  pricing: { baseMsrp: 59195, destinationCharge: 1595, optionsTotal: 3190, totalMsrp: 63980 },
  options: [
    {
      name: "Super Cruise Driver Assistance", code: "UKL", msrp: 2200,
      contents: ["Hands-Free Driving on Compatible Roads", "Automatic Lane Change", "3-Year OnStar Service Plan"],
    },
    { name: "Moonstone Gray Metallic", code: "G7Q", msrp: 495 },
    { name: "Trailering Package", code: "V08", msrp: 245, contents: ["Trailer Hitch", "7-Pin Wiring Harness"] },
    { name: "All-Weather Floor Liners", code: "RIA", msrp: 250 },
  ],
  standardEquipment: {
    safety_features: [
    ...
    exterior: [
      ...
      "275/45R22 All-Season Blackwall Tires",
      "LED Headlamps w/ LED Signature Lighting",
      "Hands-Free Power Liftgate",
      "Panoramic Fixed Glass Roof",
      "Avenir Exterior Ornamentation",
    ...
    interior: [
      "30-Inch Diagonal Color Touchscreen Display",
      "Google Built-In w/ Google Assistant and Maps",
      "Bose Premium 16-Speaker Audio System",
  ...
  assembly: { plant: "Lansing Delta Township", city: "Lansing, Michigan", country: "USA" },
  mechanical: { engine: "3.0L TURBOCHARGED V6", transmission: "8-SPEED AUTOMATIC", drivetrain: "AWD" },
  stockNumber: "B25311",
  factoryCodes: { location: null, emissions: "50 STATE", sequence: "4RV26", order: "BZAVN8", dealer: "12345" },
  epa: {
    city: 18, highway: 25, combined: 21, annualFuelCost: 2500, ghgScore: 4,
    rangeMiles: null, fuelType: "Gasoline", smogScore: 5, gallonsPer100Miles: 4.8,
    fiveYearCostDifference: -750, classNote: "Midsize SUVs range from 15 to 111 MPG.",
  },
  safety: null,
  nhtsaNotRated: true,
  partsContent: [
    { label: "U.S./Canadian parts content (carline)", value: "50%" },
    { label: "Major sources of foreign parts content", value: "Mexico 12%" },
    { label: "Final assembly point", value: "Lansing, Michigan, USA" },
    { label: "Country of origin - engine / transmission", value: "United States / United States" },
  ],
  passportUrl: "https://autolabels.io/v/demo-enclave",
  barcodePayload: "5GAEVCKS4SJ118207",
});
