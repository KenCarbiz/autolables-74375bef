...
// activate/deactivate, feature, and snapshot a new immutable version.
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-0.5">Activate, feature, and version the templates dealers can choose in Sticker Studio.</p>
      </div>
