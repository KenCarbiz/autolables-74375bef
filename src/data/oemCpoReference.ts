...
export const OEM_CPO_REFERENCE: Record<string, OemCpoReferenceEntry> = {
  ...
  GENESIS: { programName: "Genesis Certified Pre-Owned", comprehensiveMonths: 72, comprehensiveMiles: 75000, comprehensiveFrom: "in_service", powertrainMonths: 120, powertrainMiles: 100000, powertrainFrom: "in_service", maxAgeYears: 6, maxMileage: 60000, inspectionPoints: "191-point", transferable: true, confidenceStatus: "verified", sourceUrl: "https://www.genesis.com/us/en/certified", verifiedAt: V, notes: "Third-pass PDF-verified 2026-07-01 (official Limited-Warranty-Form): +1 yr/15k over new-vehicle warranty to a total 6 yr/75k from original in-service; powertrain 10 yr/100k from in-service; 191-point." },
  ...
  HYUNDAI: { programName: "Hyundai Certified Pre-Owned", powertrainMonths: 120, powertrainMiles: 100000, powertrainFrom: "in_service", maxAgeYears: 6, maxMileage: 80000, inspectionPoints: "173-point", transferable: true, confidenceStatus: "verified", sourceUrl: "https://www.hyundaiusa.com/content/hyundai/cpo/us/en/certified-pre-owned/index.html", verifiedAt: V, notes: "Third-pass PDF-verified 2026-07-01 (official HCUV warranty form): remainder of 5 yr/60k basic from in-service + 10 yr/100k CPO powertrain ($50 deductible) — no distinct fresh comprehensive wrap. Eligibility under 7 yrs old / 80k." },
  INFINITI: { programName: "INFINITI Certified Pre-Owned", comprehensiveMonths: 72, comprehensiveMiles: 75000, comprehensiveFrom: "in_service", maxAgeYears: 5, maxMileage: 60000, inspectionPoints: "167-point", transferable: true, roadside: "24/7 roadside for the coverage term", confidenceStatus: "verified", sourceUrl: "https://www.infinitiusa.com/certified-pre-owned/warranty.html", verifiedAt: V, notes: "6 yr from in-service; 75k cap or unlimited by certification-mileage tier (tier trigger secondary-corroborated only). Eligibility per official PDF: 'up to 5 years/60,000 miles'. Third-pass PDF-verified 2026-07-01; PDF also notes 1 yr complimentary maintenance + roadside for the warranty term." },
  ...
  KIA: { programName: "Kia Certified Pre-Owned", comprehensiveMonths: 12, comprehensiveMiles: 12000, comprehensiveFrom: "purchase", powertrainMonths: 120, powertrainMiles: 100000, powertrainFrom: "in_service", maxAgeYears: 6, maxMileage: 80000, inspectionPoints: "165-point", transferable: true, confidenceStatus: "verified", sourceUrl: "https://www.kia.com/us/en/cpo", verifiedAt: V, notes: "Third-pass PDF-verified 2026-07-01: 1 yr/12k Platinum from purchase, 10 yr/100k powertrain from in-service, 165-point. Kia also runs a separate 'CPO Lite' tier for 7-10-yr-old cars up to 100k mi (not modeled here)." },
  "LAND ROVER": { programName: "Land Rover Approved Certified Pre-Owned", comprehensiveMonths: 12, comprehensiveMiles: U, comprehensiveFrom: "purchase", maxAgeYears: 5, maxMileage: 60000, inspectionPoints: "165-point", transferable: true, roadside: "24/7 roadside + trip interruption for the warranty term", confidenceStatus: "verified", sourceUrl: "https://www.landroverusa.com/certified-pre-owned/warranty-certification.html", verifiedAt: "2026-07-02", notes: "Second-pass verified 2026-07-02 via ConsumerAffairs + multiple franchise dealer program pages (official page 403s to fetches): coverage begins at new-vehicle warranty expiry as EITHER 1 yr/unlimited OR 2 yr/100,000 TOTAL vehicle miles, whichever plan the certifying retailer attaches (modeled conservatively as the 1 yr/unlimited base plan — confirm which plan applies to the specific vehicle). Vehicles sold certified 48-60 months from in-service with the 1-yr plan start at the contracted sale date. Prior seeded 7 yr/100k from in-service was the OLD program shape and is retired." },
  ...
  TESLA: { programName: "Tesla Used Vehicle Limited Warranty", comprehensiveMonths: 12, comprehensiveMiles: 10000, comprehensiveFrom: "purchase", transferable: true, roadside: "24/7 roadside during the used-warranty period", confidenceStatus: "verified", sourceUrl: "https://www.tesla.com/support/vehicle-warranty", verifiedAt: "2026-07-02", notes: "Second-pass verified 2026-07-02 against Tesla's Used Vehicle Limited Warranty summary document: applies to used vehicles purchased DIRECTLY from Tesla — remainder of the 4 yr/50k basic, then 1 yr/10,000 mi (from delivery date if the basic already expired). Balance of the Battery & Drive Unit warranty transfers (8 yr/100k S, X, 3/Y Standard; 8 yr/120k 3/Y Long Range/Performance; min 70% capacity retention). No inspection-based CPO and no published age/mileage eligibility cap — eligibility left unset. Does not apply to used Teslas sold by third-party dealers." },
