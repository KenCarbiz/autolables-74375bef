...
export const OEM_WARRANTY_REFERENCE: Record<string, OemWarrantyReferenceEntry> = {
  ...
  BUICK: { basic_months: 36, basic_miles: 36000, powertrain_months: 60, powertrain_miles: 60000, corrosion_months: 72, corrosion_miles: 100000, notes: "Buick shares Chevrolet/GMC coverage (3 yr/36k basic, 5 yr/60k powertrain) — not the longer Cadillac terms." },
  ...
  TESLA: { basic_months: 48, basic_miles: 50000, powertrain_months: 96, powertrain_miles: 100000, corrosion_months: 144, corrosion_miles: U, ev_battery_months: 96, ev_battery_miles: 100000, notes: "Body corrosion 12 yr/unlimited. Battery & drive unit 8 yr; mileage 100k (Model 3/Y Standard), 120k (M3/MY Long Range/Performance), 150k (Model S/X)." },
