...
// Mirror of src/lib/market/comparables.ts, copied so the edge runtime can
...
export function canonicalizeComparable(
  ...
  const idFields: ComparableIdentityFields = {
    ...
    dealerGroupName: str(candidate.dealerGroupName),
  ...
  return {
    ...
    dealerGroupName: idFields.dealerGroupName ?? null,
