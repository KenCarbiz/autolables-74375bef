...
-- Per CGS §42-221, mandatory used-car dealer warranty applies only to vehicles
-- UNDER 7 model years old. This adds the age check so those cars default to As-Is.
