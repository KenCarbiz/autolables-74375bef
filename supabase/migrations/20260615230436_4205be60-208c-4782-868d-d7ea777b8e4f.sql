...
LANGUAGE sql STABLE SECURITY DEFINER SET search_path = public AS $$
  SELECT
    a.id, a.status::text, a.vehicle_ymm::text, a.vehicle_vin::text, a.vehicle_state::text,
    a.vehicle_price::numeric, NULL::text, NULL::uuid,
    a.addendum_date::date, a.products_snapshot, a.initials,
    a.optional_selections, a.financing_input, a.dealer_snapshot,
    a.sb766_financing_disclosure, a.sb766_three_day_return_ack,
    a.sb766_add_on_precontract, a.price_overrides, a.listing_slug::text
