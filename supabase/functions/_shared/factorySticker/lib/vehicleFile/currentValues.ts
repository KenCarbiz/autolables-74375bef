...
// Mirror of src/lib/vehicleFile/currentValues.ts, copied so the edge runtime can
...
import { identityFromListing, identityYear, type VehicleIdentity } from "../vehicleIdentity.ts";
