...
// Mirror of src/lib/factorySticker/oem/profiles.ts, copied so the edge runtime can
...
const AUTHORED_PROFILES: OemThemeProfile[] = [
  ...
  },
  {
    ...
    modelYearStart: 2022,
    modelYearEnd: 2027,
    themeVersion: "buick-us-2026-v1",
    layoutFamily: "refined-factory-technical",
    status: "draft",
    logoAuthorized: false,
  },
  {
    ...
    modelYearStart: 2022,
    modelYearEnd: 2027,
    themeVersion: "dodge-us-2026-v1",
    layoutFamily: "muscle-factory-technical",
    status: "draft",
    logoAuthorized: false,
  },
  {
    ...
    modelYearStart: 2022,
    modelYearEnd: 2027,
    themeVersion: "chrysler-us-2026-v1",
    layoutFamily: "american-factory-technical",
    status: "draft",
    logoAuthorized: false,
  },
  {
    ...
    modelYearStart: 2022,
    modelYearEnd: 2027,
    themeVersion: "land-rover-us-2026-v1",
    layoutFamily: "british-factory-technical",
    status: "draft",
    logoAuthorized: false,
  },
  {
...
const FAMILY_BY_TEMPLATE: Record<string, string> = {
  ...
  BRITISH_FACTORY: "british-factory-technical",
  AMERICAN_FACTORY: "american-factory-technical",
  MUSCLE_FACTORY: "muscle-factory-technical",
  REFINED_FACTORY: "refined-factory-technical",
